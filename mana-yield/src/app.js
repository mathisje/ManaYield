...
class App extends Component {
  ...
  _addNewSpellToDeck = (newManaCost) => {
    ...
    let newSpellArray = this.state.spellArray;
    ...
    let newSpellCostArray = newSpellArray.map(this._mapSpellsToCost);
    this.setState({
      spellArray: newSpellArray,
      spellCostArray: newSpellCostArray
    });
  };

  _cardCountChanged = (count, index) => {
    let newSpellArray = this.state.spellArray;
    newSpellArray[index].count = count;
    this.setState({
      spellArray: newSpellArray
    });
  };
